								 ...
								 <?php $total += $details['price'] * $details['quantity'] ?>                 
									<tr>
										<td class="cart_product">
											<a href=""><img src="<?php echo e($details['img']); ?>" width ="80" alt=""></a>
										</td>
										...
										<td class="cart_quantity">
											<div class="cart_quantity_button">
												...
												<input class="cart_quantity_input" type="text" name="quantity" value="<?php echo e($details['quantity']); ?>" autocomplete="off" size="2">
...
<?php /**PATH C:\xampp\htdocs\choco\resources\views/customer/cart.blade.php ENDPATH**/ ?>